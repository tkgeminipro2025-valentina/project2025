-- Ensure AI assistant session/activity tables capture the current auth user by default
...
-- Relax RLS so authenticated users can write to their own AI telemetry records
